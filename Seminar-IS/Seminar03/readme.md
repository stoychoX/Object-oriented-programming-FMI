...
## Задача втора
Да се напише функция, която прочита двоичен файл, в който е записан масив от int променливи. Нункцията да запише четните числа в един файл а нечетните в друг.