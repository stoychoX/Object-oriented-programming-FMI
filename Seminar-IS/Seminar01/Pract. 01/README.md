...
# Задача 7
Една група се състои от краен брой студенти, като броят на студентите се задава от вас. Всеки студент се характеризира с оценка, фн, група и име до 64 символа.
...
* Създайте функция, която приема група и минимален успех за стипендия и извежда сортирани всички студенти по група и фн, които ще получават стипендия идния семестър.(Сортирайте подадения масив оптимално, без да създавате нов)
