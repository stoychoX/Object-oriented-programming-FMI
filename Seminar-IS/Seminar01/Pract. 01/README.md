## Задача 2
Да се напише програма, която прочита от конзолата матрица с размер `NxM` и след това имплементирайте:
 - функция, която приема матрицата и връща нова транспонирана матрица.
 - функция, която приема два реда от матрицата и разменя местата им (разменят се първи с последен, втори с предпоследен и тн.)
