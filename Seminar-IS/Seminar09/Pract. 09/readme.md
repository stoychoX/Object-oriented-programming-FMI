...
Публичен интерфейс на класа:
 ...
 - `at(index)` - връща елемент на позиция `index`. Ако index е невалиден, се хвърля изключение
 - `front()` - връща елемента, който е най-отпред. Ако колекцията е празна, се хвърля изключение
 - `back()` - връща елемента, който е най-отзад. Ако колекцията е празна, се хвърля изключение
 ...
 - `[index]` - връща елемента на позиция `index`. Ако `index` е невалиден - оставете undefined behaviour
 - `==` - `true`, когато броя на двете колекции е равен и двата елементa на позиция `i` са равни
 - `!=`
